...
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the quiz. This means that different students are likely to get a different selection of questions, and when a quiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
$string['addrandomquestionfromeachsubcategory'] = 'Add random question from each subcategory of this category';
$string['addrandomquestionfromeachsubcategory_help'] = 'To add one or several random questions from one category, select this category and click "Add random question".

To quickly add random questions from several subcategory, make sure that they are direct descendants of the selected category and click "Add random question from each subcategory of this category".';
